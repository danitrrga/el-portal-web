...
export default function Home() {
  return (
    <div className="relative w-full bg-[var(--color-ep-bg-base)] min-h-viewport">
      ...
      <div className="absolute inset-0 -z-10 h-full w-full bg-[var(--color-ep-bg-base)] bg-[linear-gradient(to_right,var(--color-ep-grid-line)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-ep-grid-line)_1px,transparent_1px)] bg-[size:24px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none" />
